    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(choices=[('Administrateur', 'Administrateur'), ('RH', 'RH'), ('Superviseur', 'Superviseur'), ('Contrôleur', 'Contrôleur'), ('Pompiste', 'Pompiste')], max_length=50, unique=True)),
